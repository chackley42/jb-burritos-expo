...
const item3 = () => {
  ...
  return (
    <View>
      <Image
        source={require('../../images/veggieBurrito.jpeg')}
        style={styles.image}
      />
      <View style={styles.tab}>
        <Text style={styles.tabText}>Veggie Burrito</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoText}>250 Calories</Text>
        <Text style={styles.infoText}>Made with fresh tortilla, rice, beans, tomatoes, corn and cheese.</Text>
