...
const item2 = () => {
  ...
  return (
    <View>
      <Image
        source={require('../../images/beanAndCheeseBurrito.jpeg')}
        style={styles.image}
      />
      <View style={styles.tab}>
        <Text style={styles.tabText}>Bean and Cheese Burrito</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoText}>320 Calories</Text>
        <Text style={styles.infoText}>Made with fresh tortilla, bean and cheese.</Text>
